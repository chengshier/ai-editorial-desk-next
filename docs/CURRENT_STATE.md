...
- Acquisition 改为 Mission-driven：Ambient Feed + Search-first + Targeted Fetch + Targeted Platform Research。
...
- 在 Provider Spike 前把 Exa/Firecrawl/Crawl4AI/MediaCrawler 等具体实现锁死为不可替换基础设施。
...
- Acquisition architecture/provider contract；
- Legacy reuse audit；
